...
// As rotas GET de exibição (entradas, entradas/nova, saidas, saidas/nova,
// estoque, estoque/{estoque}/editar) são registradas automaticamente pelas
// respectivas Filament Pages — aqui só ficam as ações de escrita (POST/PUT),
// que continuam como Controllers comuns.
