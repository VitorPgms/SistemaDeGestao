...
// saidas, saidas/nova, saidas/{saida}/editar, estoque, estoque/{estoque}/editar) são registradas
...
Route::middleware(['web', 'auth'])->group(function () {
    ...
    Route::put('saidas/{saida}', [SaidaController::class, 'update'])->name('saidas.update');
    Route::post('saidas/{saida}/cancelar', [SaidaController::class, 'cancelar'])->name('saidas.cancelar');
